...
df = pd.DataFrame(columns=["Archivo", "COD" , "Punto de Venta", "Número de Factura", "Fecha", "Desde" , "Hasta"])
...
for i in lista_archivos:
    with pdfplumber.open(i) as pdf:
        ...
        df = pd.concat([df, pd.DataFrame([[Archivo, Cod, punto_venta, numero_factura, fecha, Desde, Hasta]], columns=["Archivo", "COD" , "Punto de Venta", "Número de Factura", "Fecha", "Desde" , "Hasta"])], ignore_index=True)
